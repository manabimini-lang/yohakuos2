  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-12 md:py-24 space-y-12">
      ...
      <div className="space-y-4 text-center sm:text-left">
        <h1 className="text-xl font-medium tracking-wide text-slate-800">小さな実践</h1>
      ...
      <div className="space-y-8">
        {loading ? (
          <div className="text-center py-12">
            <p className="text-xs text-slate-300 font-sans tracking-widest animate-pulse">図書を整理しています...</p>
          </div>
        ) : knowledges.length === 0 ? (
          <div className="text-center py-12 border border-dashed border-slate-100 rounded-2xl bg-slate-50/20">
            <p className="text-sm text-slate-400 font-serif">まだここにおかれた実践はありません。</p>
          </div>
        ) : (
          <div className="space-y-8">
            {knowledges.map((item) => {
                ...
                >
                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <h2 className="text-base font-medium text-slate-800 leading-snug group-hover:text-slate-900 transition-colors">
                        {item.title}
                      </h2>
