...
export function HakoConnectionClient() {
  ...
  return <div className="min-h-screen bg-[#f5f5f7]"><main className="mx-auto max-w-[720px] space-y-8 px-4 py-12 pb-32">
    <header className="flex items-center justify-between gap-3 px-2"><div><p className="text-sm text-slate-500">設定</p><h1 className="mt-1 text-3xl font-semibold tracking-tight text-slate-900">HAKOと接続</h1></div><Link href="/settings" className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 shadow-sm"><ArrowLeft className="h-4 w-4" />戻る</Link></header>
