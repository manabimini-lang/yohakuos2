...
export function PremiumInvitation() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto py-12 md:py-16 text-center space-y-10 selection:bg-slate-100">
      {/* Icon Badge */}
      <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-slate-50 border border-slate-150 text-muted-foreground">
        <Sparkles className="w-5 h-5 stroke-[1.5]" />
      </div>

      {/* Main Copy */}
      <div className="space-y-4 max-w-md mx-auto">
        <h2 className="text-xl font-serif text-foreground tracking-wide">
          AI整理はPremium機能です
        </h2>
      ...
      <div className="border border-slate-100 rounded-2xl bg-white p-6 text-left max-w-sm mx-auto space-y-4">
        <p className="text-xs font-semibold text-muted-foreground tracking-wider uppercase font-mono border-b border-slate-50 pb-2">
          Premium でできること
        </p>
        <ul className="space-y-3.5 text-xs text-slate-650">
          ...
          <li className="flex items-start space-x-3">
            <Route className="w-4 h-4 text-muted-foreground shrink-0 mt-0.5" />
