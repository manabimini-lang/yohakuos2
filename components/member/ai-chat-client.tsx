...
export function AiChatClient({ 
  ...
  if (!hasActiveSub) {
    return (
      <div className="rounded-3xl border border-slate-100 bg-white/50 p-10 text-center max-w-2xl mx-auto shadow-sm backdrop-blur-sm dark:border-slate-800/40 dark:bg-slate-900/10">
    ...
    return (
      <div className="max-w-xl mx-auto space-y-8 animate-in fade-in duration-500 pb-16">
        <div className="space-y-2">
          <h1 className="text-xl font-medium text-slate-950 dark:text-slate-50 tracking-tight">AI接続</h1>
        ...
        {/* Gemini Card */}
        <div className="rounded-3xl border border-slate-100 bg-white dark:border-slate-800/60 dark:bg-slate-900/45 p-6 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 transition-all">
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <h3 className="font-medium text-sm text-slate-900 dark:text-slate-100">Google Gemini</h3>
                <span className="text-[10px] font-medium text-slate-400 bg-slate-50 border border-slate-100 dark:text-slate-500 dark:bg-slate-950 dark:border-slate-800 px-2 py-0.5 rounded-full">
                  未接続
                </span>
              </div>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 bg-slate-950/40 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-100/60 dark:border-slate-800/80 rounded-3xl p-6 shadow-xl relative animate-in zoom-in-95 duration-200 flex flex-col gap-6">
              ...
              {/* Modal Header */}
              <div className="space-y-2">
                <h2 className="text-base font-semibold text-slate-950 dark:text-slate-50">Google Geminiを接続</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 bg-slate-50/50 dark:bg-slate-950/20 border border-slate-100/50 dark:border-slate-800/40 rounded-xl p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-slate-800 dark:text-slate-200">Google AI Studioを開く</span>
                  </div>
                  <div className="pt-1">
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-xs text-slate-700 bg-white border border-slate-200 dark:text-slate-300 dark:bg-slate-800 dark:border-slate-700 px-3.5 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-750 transition-colors font-medium"
                    >
                      Google AI Studioを開く
                ...
                <div className="space-y-1.5 bg-slate-50/50 dark:bg-slate-950/20 border border-slate-100/50 dark:border-slate-800/40 rounded-xl p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-slate-800 dark:text-slate-200">APIキーを作成</span>
                  </div>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 font-light leading-relaxed pl-1">
                ...
                <form onSubmit={handleConnect} className="space-y-3 bg-slate-50/50 dark:bg-slate-950/20 border border-slate-100/50 dark:border-slate-800/40 rounded-xl p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-slate-800 dark:text-slate-200">YOHAKUへ貼り付け</span>
                  </div>
                  <div className="space-y-2">
                    <input
                      type="password"
        ...
        {/* Toast Notification */}
        {toastMessage && (
          <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 bg-slate-950 dark:bg-slate-900 text-white dark:text-slate-100 px-5 py-3.5 rounded-full shadow-xl flex items-center gap-2.5 border border-slate-900 dark:border-slate-800 animate-in slide-in-from-bottom-5 fade-in duration-300">
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-12 pb-32">
      ...
      <div className="rounded-3xl border border-emerald-100 bg-emerald-50/20 dark:border-emerald-950/40 dark:bg-emerald-950/5 p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-all">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-0.5">
            <div className="flex items-center gap-2">
              <h3 className="font-medium text-xs text-slate-800 dark:text-slate-200">Google Gemini</h3>
        ...
        <button
          onClick={() => setIsModalOpen(true)}
          className="w-full sm:w-auto inline-flex items-center justify-center rounded-xl bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 border border-slate-200/85 dark:border-slate-700 px-4 py-2 text-xs font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shrink-0"
        >
          再接続
        </button>
      </div>
