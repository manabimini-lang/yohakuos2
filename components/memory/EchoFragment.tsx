...
export function EchoFragment({ fragment, narrative }: EchoFragmentProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative backdrop-blur-[1px] border border-black/5 dark:border-border/50 rounded-lg p-6 sm:p-8 overflow-hidden bg-white/50 dark:bg-black/30 hover:bg-white/60 dark:hover:bg-black/40 transition-all duration-500">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <div className="space-y-2">
            <p className="text-xs font-light tracking-widest text-black/40 dark:text-foreground/40 uppercase">
              静かな戻り
            </p>
            <h3
              className="text-2xl sm:text-3xl font-light tracking-wide text-black/80 dark:text-foreground/80 leading-relaxed"
              style={{
                opacity: 0.9,
              }}
            >
          ...
          <p className="text-sm sm:text-base font-light text-black/60 dark:text-foreground/60 leading-relaxed italic py-3 border-l-2 border-black/10 dark:border-border pl-4">
            {narrative}
          </p>

          {/* Timeline context */}
          <div className="space-y-2 pt-2">
            <div className="flex items-baseline justify-between text-xs font-light text-black/50 dark:text-foreground/50">
              <span>
          ...
          <div className="pt-4 border-t border-black/5 dark:border-border/50">
            <p className="text-xs font-light text-black/30 dark:text-foreground/30 tracking-wider">
              ✦ 遠い時間から静かに戻っています
            </p>
          </div>
        </div>
