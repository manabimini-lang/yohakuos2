...
export function CalmResurfacingCard({ resurfacing }: CalmResurfacingCardProps) {
  ...
  return (
    <div className="relative group cursor-default transition-all duration-700">
      {/* Subtle background */}
      <div className="relative backdrop-blur-[0.5px] border border-black/3 dark:border-white/3 rounded-lg p-6 sm:p-6 overflow-hidden bg-white/30 dark:bg-black/20 hover:bg-white/40 dark:hover:bg-black/30 transition-all duration-500">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <h4 className="text-xl sm:text-2xl font-light tracking-wide text-black/70 dark:text-foreground/70">
              「{resurfacing.content}」
            </h4>
          </div>
          ...
          {/* Silence narrative */}
          <div className="space-y-2">
            <p className="text-sm font-light text-black/50 dark:text-foreground/50 leading-relaxed">
              {months}ヶ月の静寂を越えて
            </p>
            <p className="text-sm italic font-light text-black/60 dark:text-foreground/60 border-l-2 border-black/5 dark:border-border/50 pl-3 py-2">
          ...
          <div className="py-4 space-y-2">
            <div className="h-1 bg-black/5 dark:bg-card rounded-full overflow-hidden">
              <div
            ...
            <p className="text-xs font-light text-black/35 dark:text-foreground/35 text-center">
              {resurfacing.fadedAt.toLocaleDateString("ja-JP")} → {resurfacing.resurfacedAt.toLocaleDateString("ja-JP")}
            </p>
          </div>

          {/* Echo marker */}
          <div className="flex items-center gap-2 text-xs font-light text-black/25 dark:text-foreground/25">
