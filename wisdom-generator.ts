...
import { WisdomInsightType, ReflectionTheme, SnapshotStatus } from "@prisma/client";
...
【条件】
・トーン：静か、観察的、非評価的、柔らかい。
・絶対に説教、指導、アドバイス、解決策の提示、行動指示、ランキング、他者比較、成功者の紹介を行わない。
・「鏡」のように、事実と傾向を伝えるだけ。
・ユーザーを導くのではなく、内省の材料を提供することに徹してください。
