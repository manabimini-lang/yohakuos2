    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-foreground">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 pb-16 sm:pb-24 space-y-8">
        <div className="space-y-6">
          ...
          <p className="text-base sm:text-lg font-light text-black/70 dark:text-foreground/70 leading-relaxed max-w-2xl">
            あなたの記録から、
            <br />
        ...
        <nav className="flex flex-col sm:flex-row gap-3 pt-4">
          <Link
            href="/memory"
            className="flex-1 px-6 py-3 rounded-lg border border-black/10 dark:border-border bg-black/[0.02] dark:bg-card hover:bg-black/[0.04] dark:hover:bg-white/[0.04] transition-colors text-center group"
          >
            <p className="text-xs font-light tracking-widest text-black/40 dark:text-foreground/40 uppercase group-hover:text-black/60 dark:group-hover:text-foreground/60 transition-colors">
              記憶の地層
            </p>
            <p className="text-xs font-light text-black/60 dark:text-foreground/60 mt-0.5">
              月ごとの記録
            </p>
          </Link>
          <Link
            href="/life"
            className="flex-1 px-6 py-3 rounded-lg border border-black/10 dark:border-border bg-black/[0.04] dark:bg-white/[0.04] text-center"
          >
        ...
        {!aiSettings?.isEnabled ? (
          <div className="p-8 rounded-2xl border border-black/10 dark:border-border bg-black/[0.02] dark:bg-card space-y-4 max-w-xl">
          ...
          <p className="text-sm font-light text-black/60 dark:text-foreground/60 leading-relaxed">
            ...
            もう少し記録が必要です。
            <br />
            <span className="text-xs text-black/40 dark:text-foreground/40 mt-2 inline-block">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24 sm:space-y-32 pb-24 sm:pb-32">
        {hasData && aiSettings?.isEnabled ? (
          ...
          <div className="py-24 text-center space-y-4">
            <p className="text-sm font-light text-black/30 dark:text-foreground/30 italic">
          ...
          <div className="py-24 sm:py-32 text-center space-y-8">
            <div className="space-y-4">
              <p className="text-lg sm:text-xl font-light text-black/60 dark:text-foreground/60">
                人生の輪郭はまだ静かに育っています。
              </p>
              <p className="text-sm font-light text-black/45 dark:text-foreground/45 max-w-md mx-auto leading-relaxed">
                記録が積み重なると、
                <br />
                テーマや方向性が少しずつ見えてきます。
              </p>
      ...
      <div className="border-t border-black/5 dark:border-border/50 py-12 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <p className="text-sm font-light text-black/40 dark:text-foreground/40 leading-relaxed max-w-lg mx-auto">
