...
var gemini_1 = require("@/lib/ai/gemini");
var cache_1 = require("next/cache");
exports.dynamic = "force-dynamic";
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var session, userId, body, apiKey, options, result, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, gemini_1.validateApiKey)(options)];
                case 4:
                    result = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json({
                ...
                case 5:
                    error_1 = _b.sent();
                    console.error("[TEST_CONNECTION_ERROR]", error_1);
                    return [2 /*return*/, server_1.NextResponse.json({
                            connected: false,
                            error: error_1.message || "疎通確認中に内部エラーが発生しました。",
                        }, { status: 500 })];
